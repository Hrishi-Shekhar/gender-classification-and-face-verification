...
# ------------------- Data Load -------------------
input_dir = r'C:\Users\roytu\Downloads\TASKB_COMYS\Comys_Hackathon5 (1)\Comys_Hackathon5\Task_A'
target_size = (300, 300)
...
cv_classifiers = {
    "Logistic Regression": LogisticRegression(penalty='l2',C=0.01,max_iter=1000, n_jobs=-1, random_state=42),
    ...
    "SVM": SVC(kernel='linear',C=0.01,probability=False, random_state=42),
